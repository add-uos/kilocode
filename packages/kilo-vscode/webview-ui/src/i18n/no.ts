...
export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigurert. Bruk Legg til-knappen ovenfor for å legge til en.",
  ...
  "settings.agentBehaviour.addMcp.command.help": "Programmet som skal kjøres (f.eks. npx, node, python).",
  ...
  "settings.agentBehaviour.addMcp.url.help": "URL-en til den kjørende MCP-serveren.",
