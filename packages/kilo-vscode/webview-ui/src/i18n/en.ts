export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty": "No MCP servers configured. Use the Add button above to add one.",
  ...
  "settings.agentBehaviour.addMcp.command.help": "The command and arguments to start the MCP server process.",
  ...
  "settings.agentBehaviour.addMcp.url.help": "The URL of the running MCP server.",
