export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверы не настроены. Используйте кнопку Добавить выше, чтобы добавить сервер.",
  "settings.agentBehaviour.addMcp": "Добавить MCP-сервер",
  "settings.agentBehaviour.addMcp.name": "Имя сервера",
  "settings.agentBehaviour.addMcp.name.description": "Уникальный идентификатор для этого MCP-сервера.",
  ...
  "settings.agentBehaviour.addMcp.nameTaken": "MCP-сервер с таким именем уже существует.",
  ...
  "settings.agentBehaviour.addMcp.command.help": "Команда и аргументы для запуска процесса MCP-сервера.",
  ...
  "settings.agentBehaviour.addMcp.url.help": "URL работающего MCP-сервера.",
