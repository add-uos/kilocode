export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Brak skonfigurowanych serwerów MCP. Użyj przycisku Dodaj powyżej, aby dodać serwer.",
  ...
  "settings.agentBehaviour.addMcp.command.help": "Plik wykonywalny do uruchomienia (np. npx, node, python).",
  "settings.agentBehaviour.addMcp.command.placeholder": "np. npx",
  ...
  "settings.agentBehaviour.addMcp.args.placeholder": "np.\n-y\n@modelcontextprotocol/server-filesystem\n/tmp",
  ...
  "settings.agentBehaviour.addMcp.url.help": "URL działającego serwera MCP.",
