export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No hay servidores MCP configurados. Usa el botón Agregar de arriba para añadir uno.",
  ...
  "settings.agentBehaviour.addMcp.command.help": "El ejecutable a ejecutar (ej. npx, node, python).",
  "settings.agentBehaviour.addMcp.command.placeholder": "ej. npx",
  ...
  "settings.agentBehaviour.addMcp.args.placeholder": "ej.\n-y\n@modelcontextprotocol/server-filesystem\n/tmp",
  "settings.agentBehaviour.addMcp.commandRequired": "El comando es obligatorio para transporte stdio.",
  "settings.agentBehaviour.addMcp.url": "URL del Servidor",
  "settings.agentBehaviour.addMcp.url.help": "La URL del servidor MCP en ejecución.",
  "settings.agentBehaviour.addMcp.url.placeholder": "e.g. http://localhost:3000/sse",
  "settings.agentBehaviour.addMcp.urlRequired": "La URL es obligatoria para transporte SSE.",
