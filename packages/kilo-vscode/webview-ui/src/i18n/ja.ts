export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCPサーバーが設定されていません。上の追加ボタンを使用してサーバーを追加してください。",
  ...
  "settings.agentBehaviour.addMcp.command.help": "実行するプログラム（例: npx、node、python）。",
  "settings.agentBehaviour.addMcp.command.placeholder": "例: npx",
  "settings.agentBehaviour.addMcp.args": "引数",
  "settings.agentBehaviour.addMcp.args.help": "1行に1つの引数。スペースを含むパスはそのまま保持されます。",
  "settings.agentBehaviour.addMcp.args.placeholder": "例:\n-y\n@modelcontextprotocol/server-filesystem\n/tmp",
  "settings.agentBehaviour.addMcp.commandRequired": "stdioトランスポートにはコマンドが必要です。",
  "settings.agentBehaviour.addMcp.url": "サーバーURL",
  "settings.agentBehaviour.addMcp.url.help": "実行中のMCPサーバーのURL。",
