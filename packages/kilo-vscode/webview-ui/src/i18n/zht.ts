...
export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty": "未設定 MCP 伺服器。使用上方的新增按鈕來新增一個。",
  ...
  "settings.agentBehaviour.addMcp.nameRequired": "伺服器名稱為必填。",
  ...
  "settings.agentBehaviour.addMcp.command.help": "要執行的程式（如 npx、node、python）。",
  "settings.agentBehaviour.addMcp.command.placeholder": "例如 npx",
  "settings.agentBehaviour.addMcp.args": "參數",
  "settings.agentBehaviour.addMcp.args.help": "每行一個參數。包含空格的路徑將按原樣保留。",
  "settings.agentBehaviour.addMcp.args.placeholder": "例如\n-y\n@modelcontextprotocol/server-filesystem\n/tmp",
  "settings.agentBehaviour.addMcp.commandRequired": "stdio 傳輸需要命令。",
  "settings.agentBehaviour.addMcp.url": "伺服器 URL",
  "settings.agentBehaviour.addMcp.url.help": "正在執行的 MCP 伺服器的 URL。",
