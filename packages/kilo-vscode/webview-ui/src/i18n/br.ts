export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty": "Nenhum servidor MCP configurado. Use o botão Adicionar acima para adicionar um.",
  ...
  "settings.agentBehaviour.addMcp.command.help": "O comando e argumentos para iniciar o processo do servidor MCP.",
  ...
  "settings.agentBehaviour.addMcp.url.help": "A URL do servidor MCP em execução.",
