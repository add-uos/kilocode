...
export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Keine MCP-Server konfiguriert. Verwenden Sie die Schaltfläche Hinzufügen oben, um einen hinzuzufügen.",
  ...
  "settings.agentBehaviour.addMcp.command.help": "Die auszuführende Datei (z.B. npx, node, python).",
  "settings.agentBehaviour.addMcp.command.placeholder": "z.B. npx",
  ...
  "settings.agentBehaviour.addMcp.args.placeholder": "z.B.\n-y\n@modelcontextprotocol/server-filesystem\n/tmp",
  ...
  "settings.agentBehaviour.addMcp.url.help": "Die URL des laufenden MCP-Servers.",
