export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Geen MCP-servers geconfigureerd. Gebruik de knop Toevoegen hierboven om er een toe te voegen.",
  ...
  "settings.agentBehaviour.addMcp.transport.stdio": "Commando (stdio)",
  "settings.agentBehaviour.addMcp.transport.sse": "URL (SSE/HTTP)",
  "settings.agentBehaviour.addMcp.command": "Commando",
  "settings.agentBehaviour.addMcp.command.help": "Het uitvoerbare bestand om te starten (bijv. npx, node, python).",
  "settings.agentBehaviour.addMcp.command.placeholder": "bijv. npx",
  "settings.agentBehaviour.addMcp.args": "Argumenten",
  "settings.agentBehaviour.addMcp.args.help": "Eén argument per regel. Paden met spaties worden ongewijzigd bewaard.",
  "settings.agentBehaviour.addMcp.args.placeholder": "bijv.\n-y\n@modelcontextprotocol/server-filesystem\n/tmp",
  "settings.agentBehaviour.addMcp.commandRequired": "Commando is vereist voor stdio-transport.",
  "settings.agentBehaviour.addMcp.url": "Server-URL",
  "settings.agentBehaviour.addMcp.url.help": "De URL van de draaiende MCP-server.",
