export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Yapılandırılmış MCP sunucusu yok. Bir tane eklemek için yukarıdaki Ekle düğmesini kullanın.",
  ...
  "settings.agentBehaviour.addMcp.nameTaken": "Bu adla bir MCP sunucusu zaten mevcut.",
  ...
  "settings.agentBehaviour.addMcp.command.help": "Çalıştırılacak program (ör. npx, node, python).",
  "settings.agentBehaviour.addMcp.command.placeholder": "ör. npx",
  "settings.agentBehaviour.addMcp.args": "Argümanlar",
  "settings.agentBehaviour.addMcp.args.help": "Her satırda bir argüman. Boşluk içeren yollar olduğu gibi korunur.",
  "settings.agentBehaviour.addMcp.args.placeholder": "ör.\n-y\n@modelcontextprotocol/server-filesystem\n/tmp",
  ...
  "settings.agentBehaviour.addMcp.url.help": "Çalışan MCP sunucusunun URL'si.",
