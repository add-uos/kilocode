...
export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty": "未配置 MCP 服务器。使用上方的添加按钮添加一个。",
  ...
  "settings.agentBehaviour.addMcp.nameRequired": "服务器名称是必需的。",
  ...
  "settings.agentBehaviour.addMcp.command.help": "要运行的可执行文件（如 npx、node、python）。",
  ...
  "settings.agentBehaviour.addMcp.url.help": "正在运行的 MCP 服务器的 URL。",
