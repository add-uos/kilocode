export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty": "لم يتم تهيئة خوادم MCP. استخدم زر الإضافة أعلاه لإضافة خادم.",
  ...
  "settings.agentBehaviour.addMcp.command.help": "الملف التنفيذي المراد تشغيله (مثل npx، node، python).",
  "settings.agentBehaviour.addMcp.command.placeholder": "مثال npx",
  "settings.agentBehaviour.addMcp.args": "الوسائط",
  "settings.agentBehaviour.addMcp.args.help": "وسيط واحد لكل سطر. المسارات التي تحتوي على مسافات تُحفظ كما هي.",
  "settings.agentBehaviour.addMcp.args.placeholder": "مثال\n-y\n@modelcontextprotocol/server-filesystem\n/tmp",
  "settings.agentBehaviour.addMcp.commandRequired": "الأمر مطلوب لنقل stdio.",
  "settings.agentBehaviour.addMcp.url": "عنوان URL للخادم",
  "settings.agentBehaviour.addMcp.url.help": "عنوان URL لخادم MCP قيد التشغيل.",
