export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nema konfiguriranih MCP servera. Koristite dugme Dodaj iznad za dodavanje jednog.",
  ...
  "settings.agentBehaviour.addMcp.nameTaken": "MCP server s ovim nazivom već postoji.",
  "settings.agentBehaviour.addMcp.transport": "Vrsta Transporta",
  "settings.agentBehaviour.addMcp.transport.stdio": "Komanda (stdio)",
  "settings.agentBehaviour.addMcp.transport.sse": "URL (SSE/HTTP)",
  "settings.agentBehaviour.addMcp.command": "Komanda",
  "settings.agentBehaviour.addMcp.command.help": "Izvršna datoteka za pokretanje (npr. npx, node, python).",
  "settings.agentBehaviour.addMcp.command.placeholder": "npr. npx",
  "settings.agentBehaviour.addMcp.args": "Argumenti",
  "settings.agentBehaviour.addMcp.args.help": "Jedan argument po liniji. Putanje s razmacima se čuvaju kako jesu.",
  "settings.agentBehaviour.addMcp.args.placeholder": "npr.\n-y\n@modelcontextprotocol/server-filesystem\n/tmp",
  "settings.agentBehaviour.addMcp.commandRequired": "Komanda je obavezna za stdio transport.",
  "settings.agentBehaviour.addMcp.url": "URL Servera",
  "settings.agentBehaviour.addMcp.url.help": "URL pokrenutog MCP servera.",
