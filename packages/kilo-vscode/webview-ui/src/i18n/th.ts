export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty": "ไม่ได้กำหนดค่าเซิร์ฟเวอร์ MCP ใช้ปุ่มเพิ่มด้านบนเพื่อเพิ่มเซิร์ฟเวอร์",
  ...
  "settings.agentBehaviour.addMcp.nameTaken": "มีเซิร์ฟเวอร์ MCP ที่มีชื่อนี้อยู่แล้ว",
  ...
  "settings.agentBehaviour.addMcp.command.help": "โปรแกรมที่จะเรียกใช้ (เช่น npx, node, python)",
  "settings.agentBehaviour.addMcp.command.placeholder": "เช่น npx",
  "settings.agentBehaviour.addMcp.args": "อาร์กิวเมนต์",
  "settings.agentBehaviour.addMcp.args.help": "หนึ่งอาร์กิวเมนต์ต่อบรรทัด พาธที่มีช่องว่างจะถูกเก็บไว้ตามเดิม",
  "settings.agentBehaviour.addMcp.args.placeholder": "เช่น\n-y\n@modelcontextprotocol/server-filesystem\n/tmp",
  ...
  "settings.agentBehaviour.addMcp.url.help": "URL ของเซิร์ฟเวอร์ MCP ที่กำลังทำงาน",
