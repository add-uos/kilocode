export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty": "Ingen MCP-servere konfigureret. Brug knappen Tilføj ovenfor for at tilføje en.",
  ...
  "settings.agentBehaviour.addMcp.command.help": "Den eksekverbare fil der skal køres (f.eks. npx, node, python).",
  "settings.agentBehaviour.addMcp.command.placeholder": "f.eks. npx",
  ...
  "settings.agentBehaviour.addMcp.args.placeholder": "f.eks.\n-y\n@modelcontextprotocol/server-filesystem\n/tmp",
  ...
  "settings.agentBehaviour.addMcp.url.help": "URL'en til den kørende MCP-server.",
