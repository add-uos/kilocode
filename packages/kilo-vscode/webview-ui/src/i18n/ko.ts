...
export const dict = {
  ...
  "settings.agentBehaviour.mcpEmpty": "MCP 서버가 구성되지 않았습니다. 위의 추가 버튼을 사용하여 서버를 추가하세요.",
  "settings.agentBehaviour.addMcp": "MCP 서버 추가",
  "settings.agentBehaviour.addMcp.name": "서버 이름",
  "settings.agentBehaviour.addMcp.name.description": "이 MCP 서버의 고유 식별자.",
  ...
  "settings.agentBehaviour.addMcp.command.help": "실행할 프로그램 (예: npx, node, python).",
  "settings.agentBehaviour.addMcp.command.placeholder": "예: npx",
  "settings.agentBehaviour.addMcp.args": "인수",
  "settings.agentBehaviour.addMcp.args.help": "한 줄에 하나의 인수. 공백이 포함된 경로는 그대로 유지됩니다.",
  "settings.agentBehaviour.addMcp.args.placeholder": "예:\n-y\n@modelcontextprotocol/server-filesystem\n/tmp",
  "settings.agentBehaviour.addMcp.commandRequired": "stdio 전송에는 명령어가 필요합니다.",
  "settings.agentBehaviour.addMcp.url": "서버 URL",
  "settings.agentBehaviour.addMcp.url.help": "실행 중인 MCP 서버의 URL.",
